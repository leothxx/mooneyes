...
<head>
	<meta charset="UTF-8">
	<title>mooneyes_service_input.jsp</title>
	<jsp:include page="/WEB-INF/views/include/bs4.jsp"></jsp:include>
	<script type="text/javascript" src="${ctp}/js/menu.js"></script>
	<script>
		'use strict';
		function service_input_btn() {
...
<body>
	...
	<div class="service_input" style="width: 100%; margin: 0 auto;">
		<div style="width: 65%; margin: 0 auto;">
			<p><br/></p>
			<form name="service_input_form" method="post">
				...
				<div class="row" style="padding: 3px 10px; border: 1px solid #ececec; border-bottom: 0px; border-top: 0px;">
					...
					<div class="col"><input type="text" id="service_title" name="service_title" class="service_input_css"/></div>
				</div>
				<div class="row" style="padding: 3px 10px; border: 1px solid #ececec; border-bottom: 0px; border-top: 0px;">
					<div class="col-2 service_input_title">내용</div>
					<div class="col"><textarea id="service_content" name="service_content" class="service_input_css" style="height: 15vh;"></textarea></div>
				</div>
				...
				<div class="row">
					<div class="col p-1"><input type="button" onclick="service_input_btn();" value="작성" class="service_input_black_btn_css"/></div>
