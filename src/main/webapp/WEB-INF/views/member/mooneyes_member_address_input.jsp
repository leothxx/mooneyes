...
<head>
	<meta charset="UTF-8">
	<title>mooneyes_member_address_input.jsp</title>
...
<body>
	...
	<div style="width: 100%; margin: 0 auto;">
		<div class="address_input_view" style="width: 75%; margin: 0 auto;">
			<form name="address_input_form" method="post">
				...
				<div class="row" style="border-bottom: 1px solid #ececec; padding: 10px; width: 100%; margin: 0 auto;">
					...
					<div class="col"><input type="text" id="member_address_as" name="member_address_as" class="address-input-css" required/></div>
				</div>
				<div class="row" style="border-bottom: 1px solid #ececec; padding: 10px; width: 100%; margin: 0 auto;">
					<div class="col-2">성명<font color='blue'>*</font></div>
					<div class="col"><input type="text" id="member_address_name" name="member_address_name" class="address-input-css"/></div>
				</div>
				<div class="row" style="padding: 10px 10px 3px 10px; width: 100%; margin: 0 auto;">
					<div class="col-2">주소<font color='blue'>*</font></div>
					<div class="col-2"><input type="text" id="sample6_postcode" name="member_address_postcode" class="address-input-css" placeholder="우편번호" readonly/></div>
				...
				<div class="row" style="padding: 3px 10px; width: 100%; margin: 0 auto;">
					<div class="col-2"></div>
					<div class="col"><input type="text" id="sample6_address" name="member_address_roadAddress" class="address-input-css" placeholder="주소" readonly/></div>
				</div>
				<div class="row" style="padding: 3px 10px; width: 100%; margin: 0 auto;">
					<div class="col-2"></div>
					<div class="col"><input type="text" id="sample6_detailAddress" name="member_address_detailAddress" class="address-input-css" placeholder="상세주소"/></div>
				</div>
				<div class="row" style="border-bottom: 1px solid #ececec; padding: 3px 10px; width: 100%; margin: 0 auto;">
					<div class="col-2"></div>
					<div class="col"><input type="text" id="sample6_extraAddress" name="member_address_extraAddress" class="address-input-css" placeholder="참고항목"/></div>
				</div>
				...
				<div class="row" style="padding: 10px;">
					<div class="col p-1"><a href="javascript:address_input();" class="address_input_black_btn_css">등록</a></div>
